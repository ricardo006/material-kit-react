      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6} md={3}>
            <AppWidgetSummary title="Total de Vendas" color="cl_vendas" total={20000} icon={<MonetizationOnTwoToneIcon />} />
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <AppWidgetSummary title="Comissão Anterior" total={234} color="cl_comissao" icon={<MonetizationOnTwoToneIcon />} />
          </Grid>
          ...
          <Grid item xs={12} md={6} lg={8}>
            <AppNewsUpdate
              ...
              list={[...Array(5)].map((_, index) => ({
                ...
                title: 'Ricardo',
                description: 'Múltipla: 5 seleções',
